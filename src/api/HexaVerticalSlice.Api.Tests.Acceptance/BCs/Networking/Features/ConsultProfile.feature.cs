...
#line hidden
        ...
        public static async System.Threading.Tasks.Task FeatureSetupAsync()
        {
            ...
            global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "BCs/Networking/Features", "Consult a profile", "In order to consult a profile\nAs a user of networking bc\nI want profiles to be cr" +
                    "eated after user has registered", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
                ...
                table15.AddRow(new string[] {
                            ...
                            "eric@company.com"});
#line 17
    await testRunner.ThenAsync("the profile details are", ((string)(null)), table15, "Then ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
...
#line hidden
                ...
                table16.AddRow(new string[] {
                            ...
                            "john@company.com"});
#line 23
    await testRunner.ThenAsync("the profile details are", ((string)(null)), table16, "Then ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
